...
@patch(
    "meinberlin.apps.bplan.tasks.get_bplan_point",
    return_value=Point(13.408151799858457, 52.51655612494057),
)
@pytest.mark.django_db
def test_bplan_api_location_task_called_if_no_point_included(
    ...
    with django_capture_on_commit_callbacks(execute=True):
        ...
        assert bplan.is_draft is False
        assert bplan.is_diplan is False
        assert bplan.point.equals(Point(13.408151799858457, 52.51655612494057))
...
def test_bplan_api_location_task_not_called_if_point_included(
    ...
    with django_capture_on_commit_callbacks(execute=True):
        ...
        assert bplan.is_draft is False
        assert bplan.is_diplan is True
        assert bplan.point.equals(Point(13.397788148643649, 52.52958586909979))
