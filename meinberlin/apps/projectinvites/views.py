...
class ParticipantInviteDetailRedirectView(generic.detail.SingleObjectMixin,
...
class ModeratorInviteDetailRedirectView(generic.detail.SingleObjectMixin,
                                        generic.base.RedirectView):
    model = models.ModeratorInvite
    slug_field = 'token'
    slug_url_kwarg = 'invite_token'
...
class DashboardProjectModeratorsView(AbstractProjectUserInviteListView):
    ...
    template_name = 'meinberlin_projectinvites/project_moderators.html'
...
class DashboardProjectParticipantsView(AbstractProjectUserInviteListView):
    ...
    model = project_models.Project
    slug_url_kwarg = 'project_slug'
    template_name = 'meinberlin_projectinvites/project_participants.html'
    permission_required = 'a4projects.change_project'
    menu_item = 'project'
