...
def test_repeated_saving_does_not_increase_count(
    ...
    insight = insight_provider(project=idea.project)
...
def test_complex_example(
    ...
    likes = [
        like_factory(question=live_questions[0]),
        like_factory(question=live_questions[1]),
        like_factory(question=live_questions[2]),
    ]
