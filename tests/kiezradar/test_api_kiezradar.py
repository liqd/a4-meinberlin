...
@pytest.mark.django_db
def test_user_can_create_kiezradar(user, apiclient, gis_point, geojson_point_str):
    ...
    assert kiezradar.point.equals(gis_point)
...
def test_user_can_update_kiezradar(
    apiclient, gis_point, geojson_point_str, kiez_radar_factory
):
    kiezradar = kiez_radar_factory()
