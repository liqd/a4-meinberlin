...
CKEDITOR_5_MAX_FILE_SIZE = 20  # restrict to 20 MB

# SVG icon for image upload dropdown
CKEDITOR_5_IMAGE_UPLOAD_ICON = (
    ...
    '<path d="M15.522 19.1a.79.79 0 0 0 .79-.79v-5.373l2.059 2.455a.79.79 0 1 0 1.211-1.015l-3.352-3.995a.79.79 0 0 0-.995-.179.784.784 0 0 0-.299.221l-3.35 3.99a.79.79 0 1 0 1.21 1.017l1.936-2.306v5.185c0 .436.353.79.79.79Z"></path>'
    '<path d="M15.522 19.1a.79.79 0 0 0 .79-.79v-5.373l2.059 2.455a.79.79 0 1 0 1.211-1.015l-3.352-3.995a.79.79 0 0 0-.995-.179.784.784 0 0 0-.299.221l-3.35 3.99a.79.79 0 1 0 1.21 1.017l1.936-2.306v5.185c0 .436.353.79.79.79Z"></path>'
    "</svg>"
)
    ...
    "image-editor": {
        ...
        "toolbar": {
            "items": [
                ...
                "link",
                {
                    "icon": CKEDITOR_5_IMAGE_UPLOAD_ICON,
                    "label": "Bild einfügen",
                    "items": ["imageUpload43", "imageUpload21"],
                },
                "fileUpload",
            ],
