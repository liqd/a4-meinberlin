...
urlpatterns = [
    ...
    path('initiators/', include(('meinberlin.apps.initiators.urls',
    ...
    path('ideas/', include(('meinberlin.apps.ideas.urls',
                            'meinberlin_ideas'),
                           'meinberlin_ideas')),
    path('kiezkasse/', include(('meinberlin.apps.kiezkasse.urls',
                                'meinberlin_kiezkasse'),
                               'meinberlin_kiezkasse')),
    path('mapideas/', include(('meinberlin.apps.mapideas.urls',
                               'meinberlin_mapideas'),
                              'meinberlin_mapideas')),
    path('text/', include(('meinberlin.apps.documents.urls',
                           'meinberlin_documents'),
                          'meinberlin_documents')),
    path('bplan/', include(('meinberlin.apps.bplan.urls',
                            'meinberlin_bplan'),
                           'meinberlin_bplan')),
    path('budgeting/', include(('meinberlin.apps.budgeting.urls',
                                'meinberlin_budgeting'),
                               'meinberlin_budgeting')),
    path('topicprio/', include(('meinberlin.apps.topicprio.urls',
                                'meinberlin_topicprio'),
                               'meinberlin_topicprio')),
    path('maptopicprio/', include(('meinberlin.apps.maptopicprio.urls',
                                   'meinberlin_maptopicprio'),
                                  'meinberlin_maptopicprio')),
    path('offlineevents/', include(('meinberlin.apps.offlineevents.urls',
                                    'meinberlin_offlineevents'),
                                   'meinberlin_offlineevents')),
    path('platform-emails/', include(('meinberlin.apps.platformemails.urls',
                                      'meinberlin_platformemails'),
                                     'meinberlin_platformemails')),
    path('questions/', include(('meinberlin.apps.livequestions.urls',
                                'meinberlin_livequestions'),
                               'meinberlin_livequestions')),
    path('', include(('meinberlin.apps.plans.urls',
                      'meinberlin_plans'),
                     'meinberlin_plans')),
    ...
    path('browse/', never_cache(user_is_project_admin(ck_views.browse)),
